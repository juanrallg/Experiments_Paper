...
% effect of the overprediction near the fin shock affects the numerical data also in the vortex-injection tests.
...
% were satisfactorily accurate in the regions not adjacent to the fin shock.
This increased correlation suggests the that the numerical methodology was able to accurately predict the far-field but needs improvement in the separation region of the fin shock for both the fueled and unfueled scenarios.
% flowfield is accurately predicted in by the numerical methodology.
