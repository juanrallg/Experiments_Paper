...
The exit profile from this simulation is used as the inflow  boundary condition for the three-dimensional numerical domain described above.
...
The cell growth from the injector is restricted to $\SI{1}{\milli\meter}$ in the region of uniform flow and is considered an appropriate limit to resolve the far-field of the vortex-injection interaction.
...
% KDB. I do not agree with this statement. It does not correctly simulate it. It is the best approximation as shown by the data in this paper. I'll let you choose what you would like to do though Juan.
