...
For these reasons, using air-breathing propulsion for access-to-space missions has the potential to increase the overall efficiency of the missions as well as decrease the cost per kilogram of placing satellites into orbit.
% efficiency of low earth orbit satellite placement missions can be improved by using scramjet propulsion.
...
% KDB: Wasn't sure if you meant an decrease in the total propulsive efficiency as this may increase with an inreased combustion efficiency. I would  double check this statement.
...
% KDB: I can't access the UQ library so you will need to verify my edits associated with the referenced papers.
Non-axisymmetric inlets inherently generate vortices due to the shock-wave boundary-layer interactions present~\cite{Alvi} and have been shown to produce improvements in mixing rates~\cite{SpacePlanes_paper2015,Llobet_PlumeElongation}.
% These vortices have been shown to produce relevant
