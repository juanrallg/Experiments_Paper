...
The two pressures tested were $P_{inj}=\SI{1300}{\kilo\pascal}$ and $P_{inj}=\SI{430}{\kilo\pascal}$, which are named the High Injection (HI) and Low Injection (LI) cases respectively.
