...
Shown in Fig.~\ref{fig:ModelPics}, this geometry used in the experimental testing is equivalent to the one used in previous numerical studies~\cite{SpacePlanes_paper2015,AFMCpaper2014,JSASS_paper,Llobet_PlumeElongation}.
% and is depicted in Fig.~\ref{fig:ModelPics}.
For the experimental testing the fin angle was set at \ang{10}.
This angle was chosen as relatively strong vortex withing an intensity representative of that of vortices present in real scramjet inlets~\cite{AFMCpaper2014,SpacePlanes_paper2015}.
