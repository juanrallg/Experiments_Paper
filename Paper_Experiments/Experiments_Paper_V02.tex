...
The fin can be translated in the model Y axis to allow different fin-to-injector distance ratios.
Shown in Fig.~\ref{fig:GaugesonModel}, by translating the fin, the relative injector position in the Y axis changes, allowing for different injection locations in the vortex to be tested. 
